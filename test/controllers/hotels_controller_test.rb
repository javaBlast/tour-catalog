...
class HotelsControllerTest < ActionController::TestCase
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post :create, hotel: { description: @hotel.description, image_url: @hotel.image_url, price: @hotel.price, title: @hotel.title }
    end
  ...
  test "should update hotel" do
    patch :update, id: @hotel, hotel: { description: @hotel.description, image_url: @hotel.image_url, price: @hotel.price, title: @hotel.title }
    assert_redirected_to hotel_path(assigns(:hotel))
  end
